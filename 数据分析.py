# pip install pip install --upgrade numpy  -i https://pypi.tuna.tsinghua.edu.cn/simple/

# 基于微博 新冠疫情评论 的 TFIDF word2vec 新冠关键词聚类分析 词云 提取关键词 聚类分析词性 先看数据： 我直接运行
# 词性相近的词语 聚类分析是相近的
import gensim
import requests
import pandas as pd
...
def jieba_cut_word(text):
    ...
    return res1
data = pd.read_csv("重庆城市科技学院问答.csv", encoding='utf-8')
